...
<IsoStackFigure
  ...
  satellites={[
    { layer: 5, side: 'left', label: 'PROJECT MEMORY', sub: 'NOTES, RECALLED PER QUESTION' },
    { layer: 5, side: 'right', label: 'LESSONS', sub: 'FROM YOUR REPORTS, PLATFORM-WIDE' },
  ]}
/>
...
The two dashed boxes feed the answer without being layers themselves: a project memory that keeps later conversations from starting at zero, and the lessons distilled from thumbs-down reports across the whole platform. Both get their own section below; the lesson loop even gets [its own post](/en/blog/a-system-that-learns-from-your-frustration/).
...
Want to see it on your own project? [Become a pilot office](/en/#kontakt).
