...
export const SkillRawDocumentSection: FC<SkillRawDocumentSectionProps> = ({
  ...
  return (
    ...
    >
      <CollapsibleTrigger
        type="button"
        className="hover:bg-muted focus-visible:ring-ring/50 flex w-full items-center justify-between gap-3 rounded-xl px-4 py-3 text-left transition-colors duration-quick ease-out focus-visible:outline-none focus-visible:ring-2"
      >
        ...
        <ChevronDown
          className={cn(
            'text-muted-foreground size-4 shrink-0 transition-transform duration-quick ease-out motion-reduce:transition-none',
            open && 'rotate-180',
          )}
          aria-hidden
        />
