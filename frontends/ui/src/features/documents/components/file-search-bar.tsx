          ...
          <div className="relative flex-1">
            ...
            {value !== '' && (
              <button
                ...
                className="absolute right-1 top-1/2 flex size-9 pointer-coarse:size-11 -translate-y-1/2 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring motion-reduce:transition-none md:right-1.5 md:size-6"
              >
