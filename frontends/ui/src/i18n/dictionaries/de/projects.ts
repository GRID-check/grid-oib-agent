...
export const projects: typeof en.projects = {
  ...
  intake: {
    ...
    schnellstartOn: 'Nur Kernfragen. Alles Übrige wird als „offen“ übernommen und in der Zusammenfassung als offener Punkt gelistet.',
    ...
    coreBadge: 'Kernfrage',
    hiddenByQuickstart: '{count, plural, one {# weitere Frage} other {# weitere Fragen}} im Schnellstart ausgeblendet',
