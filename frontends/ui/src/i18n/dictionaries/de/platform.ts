...
export const platform: typeof en.platform = {
  ...
  answerFeedback: {
    ...
    trendAria: 'Täglicher Anteil negativer Bewertungen',
    trendDown: '{points} Punkte besser',
    trendUp: '{points} Punkte schlechter',
    trendFlat: 'Weitgehend unverändert',
    trendAverageMark: 'Ø',
    legendRate: 'Negativanteil pro Tag',
    legendSparse: 'Unter {min} Bewertungen — nicht gemessen',
    legendAverage: 'Ø im Zeitraum ({pct} %)',
    legendVolume: 'Bewertungen an dem Tag',
    trendPoint: '{pct} % negativ von {votes} Bewertungen',
    ...
    downRate: 'der Bewertungen waren negativ',
    up: 'hilfreich',
    ...
    defectsHeading: 'Misslungene Antworten',
    noDefects: 'In diesem Zeitraum gab es kein negatives Feedback.',
