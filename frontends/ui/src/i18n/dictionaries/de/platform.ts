...
export const platform: typeof en.platform = {
  ...
  answerFeedback: {
    ...
    digest: {
      ...
      causes: 'Negative Stichprobe nach Ursache:',
      cause: {
        wrong_value: 'falscher Wert',
        wrong_rule: 'falsche Vorschrift',
        incomplete: 'unvollständig',
        misunderstood: 'Frage missverstanden',
        no_source: 'keine prüfbare Quelle',
        not_found: 'Dokument nicht gefunden',
        form: 'Form',
        slow: 'zu langsam',
        broken: 'Antwort defekt',
        other: 'Sonstiges',
      },
  ...
  sections: {
    overview: {
      title: 'Übersicht',
      subtitle: 'Alle Organisationen der Plattform mit Projekten, LLM-Kosten und Umsatz — und die Preisliste dahinter.',
    },
    skills: {
      title: 'Skills',
      subtitle:
  ...
  orgs: {
    ...
    description:
      'Alle Organisationen der Plattform, größter Umsatz zuerst. Kosten sind das, was OpenRouter in USD verrechnet hat; Umsatz ist, was der Organisation laut Preisliste berechnet wird.',
  ...
  trend: {
    title: 'Kostenverlauf',
    description: 'Plattformweite LLM-Kosten pro Tag der letzten 30 Tage (UTC), in USD wie verrechnet, aus dem Nutzungsregister.',
  ...
  pricing: {
    title: 'Preisliste',
    description:
      'Was Organisationen für das bezahlen, was OpenRouter Piloti verrechnet. Kosten × Marge ist der Preis; Preis ÷ Punktpreis ist, was sie sehen. Ein Speichern gilt für jede Organisation ab ihrer nächsten Anfrage — bereits Erfasstes wird nicht neu bepreist.',
    setBadge: 'Festgelegt',
    bootFloorBadge: 'Grundeinstellung — noch nicht festgelegt',
    margin: 'Margenfaktor',
    marginHint: 'Preis ÷ Kosten. 1 ist Weitergabe zum Selbstkostenpreis; 2,5 ist ein Aufschlag von 150 %. {min}–{max}.',
    usdPerCredit: 'Punktpreis (USD Preis pro Punkt)',
    usdPerCreditHint: 'Wie viel Preis ein Punkt darstellt. Was ein Punkt in Euro kostet, regelt der Vertrag.',
    defaultDaily: 'Voreingestelltes Tageskontingent (Punkte)',
    defaultMonthly: 'Voreingestelltes Monatskontingent (Punkte)',
    unlimitedPlaceholder: 'Unbegrenzt',
    example: 'Eine Anfrage, für die OpenRouter {cost} verrechnet, kostet {price} und erscheint als {credits} Punkte.',
    exampleIncomplete: 'Geben Sie Marge und Punktpreis ein, um ein Rechenbeispiel zu sehen.',
    note: 'Änderungsnotiz',
    notePlaceholder: 'Warum diese Preisliste (optional)',
    save: 'Preisliste speichern',
    saved: 'Preisliste gespeichert — gilt ab der nächsten Anfrage.',
    saveError: 'Die Preisliste konnte nicht gespeichert werden.',
    loadError: 'Die Preisliste konnte nicht geladen werden.',
    confirmTitle: 'Preisliste für alle Organisationen ändern?',
    confirmDescription:
      'Ab der nächsten Anfrage wird jede Organisation mit diesen Werten bepreist. Bereits erfasste Nutzung behält den Preis, zu dem sie erfasst wurde.',
    confirmSave: 'Für alle Organisationen speichern',
    updatedBy: 'Festgelegt von {email} am {date}',
    historyTitle: 'Frühere Versionen',
    historyEntry: '{margin}× · {usdPerCredit} pro Punkt · {daily}/Tag · {monthly}/Monat',
  },
  team: {
