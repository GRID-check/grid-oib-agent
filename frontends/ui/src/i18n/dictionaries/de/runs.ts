...
export const runs: typeof en.runs = {
  ...
  plan: {
    ...
    documents: '{count, plural, one {# Schwerpunkt} other {# Schwerpunkte}}',
    documentsOnly: 'nur {count, plural, one {# Unterlage} other {# Unterlagen}}',
    excluded: '{count, plural, one {# ausgeschlossen} other {# ausgeschlossen}}',
    stage: { proposed: 'Vorgeschlagen', held: 'Angehalten', approved: 'Freigegeben', started: 'Läuft' },
    saving: 'Wird gespeichert …',
    saved: 'Jede Änderung wird sofort gespeichert.',
    more: '+ {count} weitere',
    dialogTitle: 'Recherche planen',
    dialogDescription:
      'Frage, Gliederung, Art – mehr braucht es nicht. Unterlagen sind optional. Die Recherche beginnt, sobald Sie den Plan anlegen.',
    question: 'Ihre Frage',
    questionHint: 'Was die Recherche beantworten soll. Sie wird zum Titel des Berichts.',
    ...
    preview: 'Vorschau',
    previewQuestion: 'Ihre Frage erscheint hier.',
    previewSections: 'Noch keine Abschnitte.',
    previewNext:
      'Nach dem Anlegen erscheint der Auftrag im Verlauf. Dort sehen Sie, was die Recherche liest, und können sie jederzeit abbrechen.',
    needQuestion: 'Frage',
    needSection: 'mindestens ein Abschnitt',
