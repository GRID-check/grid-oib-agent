...
export const chat: typeof en.chat = {
  ...
  agentPrompt: {
    plan: {
      ...
      steps: {
        sections: {
          title: 'Was der Bericht behandelt',
          hint: 'Jeder Abschnitt wird ein Kapitel, in dieser Reihenfolge. Streichen, ergänzen oder Vorschläge übernehmen.',
        },
        form: {
          title: 'Wie er aussieht',
          hint: 'Die Art bestimmt den Aufbau, die Tiefe den Umfang.',
        },
        documents: {
          title: 'Welche Unterlagen',
          hint: 'Piloti kann alle Unterlagen lesen. Hier setzen Sie Schwerpunkte, beschränken auf ausgewählte oder schließen einzelne aus.',
        },
        rahmen: {
          title: 'Worin gesucht wird',
          hint: 'Die Quellen, die beim Start gewählt waren. Sie stehen mit dem Auftrag fest.',
        },
      },
      optional: 'optional',
      emptySections: 'Noch keine Abschnitte. Tragen Sie unten einen ein oder übernehmen Sie eine fertige Gliederung.',
      useTemplate: 'Gliederung „{genre}“ übernehmen',
      suggestions: 'Vorschläge:',
      suggest: 'Abschnitt übernehmen: {point}',
      sectionTemplates: {
        pruefbericht: {
          s1: 'Rechtsrahmen und Einstufung',
          s2: 'Anforderungen',
          s3: 'Nachweis im Projekt',
          s4: 'Abweichungen und Kompensation',
          s5: 'Befunde und offene Punkte',
        },
        aktenvermerk: {
          s1: 'Anlass',
          s2: 'Sachverhalt',
        ...
        vergleich: {
          s1: 'Gegenstand des Vergleichs',
          s2: 'Kriterien',
          s3: 'Gegenüberstellung',
          s4: 'Bewertung',
          s5: 'Empfehlung',
        },
        checkliste: {
          s1: 'Voraussetzungen',
          s2: 'Unterlagen und Nachweise',
          s3: 'Prüfpunkte',
          s4: 'Fristen und Zuständigkeiten',
          s5: 'Offene Punkte',
        },
        bericht: {
          s1: 'Ausgangslage',
          ...
          s3: 'Analyse',
          s4: 'Ergebnis',
          s5: 'Quellen und offene Fragen',
        },
      },
      unterlagen: {
        grundlage: 'Schwerpunkt:',
        grundlageOnly: 'Nur diese:',
        ausgeschlossen: 'Ausgeschlossen:',
        chooseFocus: 'Schwerpunkte wählen …',
        chooseOnly: 'Unterlagen wählen …',
        chooseExcluded: 'Ausschließen …',
        pickFocusTitle: 'Schwerpunkte wählen',
        pickFocusDescription: 'Diese Unterlagen liest die Recherche zuerst und vollständig. Alle anderen bleiben verfügbar.',
        pickOnlyTitle: 'Unterlagen für diese Recherche',
        pickOnlyDescription: 'Von Ihren Unterlagen verwendet die Recherche nur diese. Regelwerke und Normen bleiben verfügbar.',
        pickExcludedTitle: 'Unterlagen ausschließen',
        pickExcludedDescription: 'Diese Unterlagen verwendet die Recherche nie, auch wenn eine Suche sie findet.',
        removeRead: 'Nicht mehr ausgewählt: {name}',
        removeExcluded: 'Nicht mehr ausgeschlossen: {name}',
        scope: 'Welche Unterlagen die Recherche verwendet',
        scopeAll: 'Alle Unterlagen',
        scopeOnly: 'Nur ausgewählte',
        scopeAllHint:
          'Die Recherche kann alle Unterlagen lesen. Ausgewählte liest sie zuerst und vollständig, ausgeschlossene nie.',
        scopeOnlyHint:
          'Von Ihren Unterlagen verwendet die Recherche nur {count, plural, one {die ausgewählte} other {die # ausgewählten}}. Regelwerke und Normen bleiben verfügbar.',
        scopeOnlyEmpty: 'Wählen Sie mindestens eine Unterlage aus. Bis dahin liest die Recherche alle.',
      },
    },
