...
export const chat: typeof en.chat = {
  ...
  agentPrompt: {
    plan: {
      ...
      depth: 'Tiefe',
      depths: { kurzpruefung: 'Kurzprüfung', gutachten: 'Ausführlich' },
      genreHints: {
      ...
      steps: {
        ...
        documents: {
          title: 'Was Piloti liest',
        },
      },
      optional: 'optional',
      emptySectionsTitle: 'Noch keine Gliederung',
      ...
      unterlagen: {
        searchesLead: 'Piloti durchsucht',
        searchesTail: 'und wählt selbst, was zur Frage passt.',
        searchesAll: 'Piloti durchsucht alle Unterlagen und Quellen des Auftrags und wählt selbst, was zur Frage passt.',
        chooseFirst: 'Bestimmte Unterlagen zuerst lesen …',
        changeFirst: 'Auswahl ändern …',
        readFirst: 'Zuerst gelesen:',
        onlyThese: 'Nur diese:',
        onlyTheseToggle: 'Nur diese verwenden',
        onlyTheseNote: 'Von Ihren Unterlagen verwendet die Recherche nur diese. Regelwerke und Normen bleiben verfügbar.',
        pickFirstTitle: 'Welche Unterlagen soll Piloti zuerst lesen?',
        pickFirstDescription:
          'Die gewählten liest die Recherche vollständig, bevor sie weitersucht. Alle anderen bleiben verfügbar, außer Sie setzen unten „Nur diese verwenden".',
        excludeLabel: 'Unterlagen ausschließen',
        excludedSummary: '{count, plural, one {# ausgeschlossen} other {# ausgeschlossen}}',
        excludeHint: 'Etwa einen überholten Stand, den eine Suche sonst finden würde.',
        excludeWithOnly: 'Solange „Nur diese" gilt, verwendet die Recherche ohnehin keine anderen. Ausgeschlossene bleiben gespeichert.',
