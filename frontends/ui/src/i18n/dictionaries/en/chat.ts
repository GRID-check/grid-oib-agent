    ...
    plan: {
      ...
      steps: {
        ...
        documents: {
          ...
          hint: 'Piloti can read every document. Here you set a focus, limit it to a selection, or exclude single ones.',
        },
        rahmen: {
          title: 'Where it searches',
          hint: 'The sources chosen when the task started. They are fixed with the task.',
        },
      },
      optional: 'optional',
      ...
      unterlagen: {
        ...
        chooseOnly: 'Choose documents …',
        chooseExcluded: 'Exclude …',
        pickFocusTitle: 'Choose a focus',
        pickFocusDescription: 'The research reads these first and in full. Everything else stays available.',
        pickOnlyTitle: 'Documents for this research',
        pickOnlyDescription: 'Of your documents the research uses only these. Regulations and standards stay available.',
        pickExcludedTitle: 'Exclude documents',
        pickExcludedDescription: 'The research never uses these, even when a search finds them.',
        removeRead: 'No longer selected: {name}',
        removeExcluded: 'No longer excluded: {name}',
        scope: 'Which documents the research uses',
        scopeAll: 'All documents',
        scopeOnly: 'Only selected',
        scopeAllHint: 'The research can read every document. It reads selected ones first and in full, excluded ones never.',
        scopeOnlyHint:
          'Of your documents the research uses only {count, plural, one {the selected one} other {the # selected}}. Regulations and standards stay available.',
        scopeOnlyEmpty: 'Select at least one document. Until then the research reads all of them.',
      },
    },
