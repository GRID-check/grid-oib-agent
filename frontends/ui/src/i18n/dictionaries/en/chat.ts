...
export const chat = {
  ...
  agentPrompt: {
    plan: {
      ...
      depth: 'Depth',
      depths: { kurzpruefung: 'Short review', gutachten: 'In depth' },
      genreHints: {
      ...
      steps: {
        sections: {
          ...
          hint: 'Each section becomes a chapter, in this order. Remove, add, or take a suggestion.',
        },
        form: {
          title: 'What it looks like',
          hint: 'The kind sets the structure, the depth the length.',
        },
        documents: {
          title: 'What Piloti reads',
        },
      },
      optional: 'optional',
      emptySectionsTitle: 'No outline yet',
      emptySections: 'No sections yet. Add one below, or start from a ready outline.',
      useTemplate: 'Use the „{genre}“ outline',
      suggestions: 'Suggestions:',
      suggest: 'Add section: {point}',
      sectionTemplates: {
        pruefbericht: {
          s1: 'Legal framework and classification',
          s2: 'Requirements',
          s3: 'Evidence in the project',
          s4: 'Deviations and compensation',
          s5: 'Findings and open points',
        },
        aktenvermerk: {
          s1: 'Occasion',
          s2: 'Facts',
        ...
        checkliste: {
          s1: 'Preconditions',
          s2: 'Documents and evidence',
          s3: 'Checks',
          s4: 'Deadlines and responsibilities',
          s5: 'Open points',
        },
        bericht: {
          s1: 'Starting point',
          ...
          s3: 'Analysis',
          s4: 'Result',
          s5: 'Sources and open questions',
        },
      },
      unterlagen: {
        searchesLead: 'Piloti searches',
        searchesTail: 'and picks what fits the question.',
        searchesAll: 'Piloti searches every document and source of the task and picks what fits the question.',
        chooseFirst: 'Read certain documents first …',
        changeFirst: 'Change selection …',
        readFirst: 'Read first:',
        onlyThese: 'Only these:',
        onlyTheseToggle: 'Use only these',
        onlyTheseNote: 'Of your documents, the research uses only these. Regulations and standards stay available.',
        pickFirstTitle: 'Which documents should Piloti read first?',
        pickFirstDescription:
          'The research reads the chosen ones in full before it searches further. Everything else stays available unless you tick „Use only these" below.',
        excludeLabel: 'Exclude documents',
        excludedSummary: '{count, plural, one {# excluded} other {# excluded}}',
        excludeHint: 'Such as an outdated revision a search would otherwise find.',
        excludeWithOnly: 'While „Only these" applies, the research uses no others anyway. Exclusions are kept.',
        neverUsed: 'Never used:',
        chooseExcluded: 'Exclude …',
        pickExcludedTitle: 'Exclude documents',
        pickExcludedDescription: 'The research never uses these documents, even when a search finds them.',
        grundlage: 'Read first:',
        grundlageOnly: 'Only these:',
        ausgeschlossen: 'Excluded:',
        removeRead: 'No longer selected: {name}',
