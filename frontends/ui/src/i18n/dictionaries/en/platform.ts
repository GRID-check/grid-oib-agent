...
export const platform = {
  ...
  answerFeedback: {
    ...
    subtitle: 'What users thought of their answers over the last {days} days — and the questions behind the ones that missed.',
    refresh: 'Refresh',
    export: 'Export CSV',
    trendHeading: 'Direction',
    trendAria: 'Daily share of votes that were negative',
    trendDown: '{points} points better',
    trendUp: '{points} points worse',
    trendFlat: 'Roughly flat',
    trendAverageMark: 'avg',
    legendRate: 'Negative share per day',
    legendSparse: 'Under {min} votes — not measured',
    legendAverage: 'Window average ({pct}%)',
    legendVolume: 'Votes that day',
    trendPoint: '{pct}% negative of {votes} votes',
    ...
    downRate: 'of votes were negative',
    up: 'helpful',
    down: 'not helpful',
    percent: '{value}%',
    ...
    defectsHeading: 'Answers that missed',
    noDefects: 'No negative feedback in this window.',
