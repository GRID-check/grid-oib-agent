...
export const platform = {
  ...
  knowledgeAdmin: {
    ...
    bulkReingestDone:
      'Re-indexing {count, plural, one {# document} other {# documents}}. The status updates as each one finishes.',
  ...
  answerFeedback: {
    ...
    digest: {
      ...
      nextStep: 'Next step:',
      causes: 'Sampled unhelpful votes by cause:',
      cause: {
        wrong_value: 'wrong value',
        wrong_rule: 'wrong regulation',
        incomplete: 'incomplete',
        misunderstood: 'misunderstood question',
        no_source: 'no checkable source',
        not_found: 'document not found',
        form: 'form',
        slow: 'too slow',
        broken: 'broken answer',
        other: 'other',
      },
