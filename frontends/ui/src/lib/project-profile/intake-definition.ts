  ...
  stages: [
    ...
    // ------------------------------------------------------------------ C
    {
      ...
      questions: [
        ...
        {
          id: 'C_GK_CONFIRM',
          label: 'Abgeleitete Gebäudeklasse',
          type: 'info_placeholder',
          derives: 'gebaeudeklasse',
          hint: 'Sobald die Klassifizierungs-Engine (Phase 2) angebunden ist, erscheint hier die aus C2/C4/C5/C6/C7/C8 abgeleitete Gebäudeklasse zur Bestätigung — bei offenen Parametern als Bandbreite.',
          conditions: [{ param: 'C1', op: 'equals', value: 'gebaeude' }],
        },
      ],
    },
    ...
    // ------------------------------------------------------------------ F
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: 'info_placeholder',
          derives: 'uvp',
          hint: 'Die Klassifizierungs-Engine prüft die Schwellenwerte des UVP-G 2000 (Stellplätze gesamt, Verkaufsflächen, Städtebauvorhaben) und zeigt eine Ampel „zu prüfen“.',
        },
        {
          id: 'F3',
    ...
    // ------------------------------------------------------------------ H
    {
      ...
      scope: 'projekt',
      description: 'Ihre Angaben im Überblick. Hier bestätigen Sie die abgeleiteten Klassifizierungen, bevor das Profil an Piloti übergeben wird.',
      questions: [],
    },
  ],
}
