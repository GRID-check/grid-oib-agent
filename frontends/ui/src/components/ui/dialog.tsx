    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close
          ...
          className={cn(
            'absolute top-4 right-4 inline-flex size-8 items-center justify-center rounded-md text-muted-foreground outline-none transition-colors hover:bg-accent hover:text-foreground disabled:pointer-events-none disabled:opacity-50 pointer-coarse:size-11 pointer-coarse:top-2.5 pointer-coarse:right-2.5',
            FOCUS_RING,
          )}
        >
