...
const request = (): Request => new Request('https://grid.example/api/organization/audit-portal', { method: 'POST' })
...
describe('POST /api/organization/audit-portal', () => {
  ...
  it('returns an org-scoped portal link for authorized viewers', async () => {
    ...
    expect(generateAuditPortalLink).toHaveBeenCalledWith('org_1', 'https://grid.example/app/organization')
  })
