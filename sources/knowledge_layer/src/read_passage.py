    ...
    async def _read(
        ...
        Args:
            ...
            punkt (str | None): The Punkt number alone, e.g. "3.5.2" — no
                "Pkt.", no title.
            page (int | str | None): The page number, 1-based. May be combined with
                `punkt` to read that Punkt on that page. ``''`` is treated as
                omitted (#656: providers send empty string for "no page").
