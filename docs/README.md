...
| Surfaces | [`design/grid-design-language.md`](design/grid-design-language.md), [`design/run-block.md`](design/run-block.md) (what a run looks like in the thread, and how its moves are ordered), [`design/streaming-chat-answer.md`](design/streaming-chat-answer.md), which drawing an answer carries and when: [`design/answer-visuals.md`](design/answer-visuals.md), how a diagram is read and drawn: [`architecture/diagrams.md`](architecture/diagrams.md), [`design/project-surfaces.md`](design/project-surfaces.md), [`design/grid-card-charter.md`](design/grid-card-charter.md) |
