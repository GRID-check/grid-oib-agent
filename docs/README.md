...
| Surfaces | [`design/grid-design-language.md`](design/grid-design-language.md), [`design/run-block.md`](design/run-block.md) (what a run looks like in the thread, and how its moves are ordered), [`design/streaming-chat-answer.md`](design/streaming-chat-answer.md), [`design/project-surfaces.md`](design/project-surfaces.md), [`design/grid-card-charter.md`](design/grid-card-charter.md) |
