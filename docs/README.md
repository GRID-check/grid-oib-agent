...
| [`roadmap/`](roadmap/) | Where this is going: the agentic workspace review, the artifact design of record, its product-perspective review and the continuous-improvement ledger, IFC, spatial reasoning, cross-project RAG | You are scoping something that is not built yet |
