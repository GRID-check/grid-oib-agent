...
- Both images are **digest-pinned** in `deploy/pulumi/src/config.ts`
  (`aspire-dashboard@sha256:d71f…` = 13.4.2, `opentelemetry-collector-contrib@sha256:fd32…`
  = 0.161.0); upgrades are deliberate config changes, not mutable-tag surprises.
