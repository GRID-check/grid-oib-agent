...
**Who is writing.** While a colleague is composing, their name and three dots appear at the foot of the chat — deliberately a different shape from Piloti's own status, so a pause is legible at a glance as a person thinking rather than the assistant working. It disappears when they send, clear the box, or stop; nothing about it is stored.
