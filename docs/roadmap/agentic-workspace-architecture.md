...
| delete | `card_generator_llm` (a field nothing read), the unmaintained `config_grid_oib.yml`, the two-hop research → history → chat redirect, and the backlog lines closed at HEAD | `chat_researcher/register.py`, `configs/`, `backlog.md` |
