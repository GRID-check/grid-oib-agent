"""Payload parsing: the shapes one user message can arrive in."""
...
class TestExtractQueryFromText:
    ...
    def test_extract_plain_text(self):
        ...
        query, sources, _skills, _intent = _extract_query_from_text("What is CUDA?")
        assert query == "What is CUDA?"
        assert sources is None

    def test_extract_empty_text(self):
        """Test extracting from empty text."""
        query, sources, _skills, _intent = _extract_query_from_text("")
        assert query == ""
        assert sources is None
    ...
    def test_extract_json_payload_with_query(self):
        ...
        query, sources, _skills, _intent = _extract_query_from_text(text)
        assert query == "What is CUDA?"
...
class TestExtractQueryAndSourcesDict:
    ...
    def test_extract_from_simple_dict(self):
        ...
        query, sources, _skills, _intent = _extract_query_and_sources(payload)
...
class TestExtractQueryAndSourcesString:
    ...
    def test_extract_from_plain_string(self):
        ...
        query, sources, _skills, _intent = _extract_query_and_sources("Plain query string")
