...
from aiq_agent.agents.researcher.agent import _FANOUT_DROPPED_MESSAGE
from aiq_agent.agents.researcher.agent import _ROUND_ZERO_SEARCH_LIMIT
...
@pytest.fixture
def scripted_agent():
    """A ResearcherAgent whose LLM plays a fixed script of tool rounds."""
...
async def _run(agent: ResearcherAgent, question: str = "Wie lang darf der Fluchtweg sein?"):
